...
public class InjectLocalServiceViaObjectTestActivity extends RobojectActivity {
    static {
        ServiceRegistry.registerService(AdderInterface.class, new AdderImplementation());
    }
